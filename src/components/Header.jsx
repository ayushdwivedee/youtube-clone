...
const Header = () => {
  ...
  const { loading, mobileMenu, setMobileMenu } = useContext(ContextApi);
    ...
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black">
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className=" flex h-5 items-center">
          <img
            className="h-full hidden sm:hidden md:block   dark:md:block"
            src={ytLogo}
            alt="Youtube"
          />
      ...
      <div className="group flex items-center   ">
        <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-slate-500 rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 ">
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <img src="https://xsgames.co/randomusers/assets/avatars/male/8.jpg" />
        </div>
      </div>
    </div>
  );
